$(document).ready(function(){
    $("#id_is_offered").click(function() {
    	...
    	$("#div_id_is_offered_to").css('display', 'none')
    	// alert('hello');
    });
...
$("#div_id_is_offered").on("click", "#id_is_offered", function(){
    if($("#id_is_offered").is(':checked')){
        // alert('checked');
        $("#div_id_is_offered_to").css('background-color', 'red');
        $("p_toggle").toggle();
    } else {
        alert('un-checked');
        $("#div_id_is_offered_to").css('background-color', 'blue');
    }
});
